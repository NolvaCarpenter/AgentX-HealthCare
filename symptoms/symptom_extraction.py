...
class SymptomDetailExtractor:
    ...
    def extract_detail(self, symptom_name: str, detail_type: str, user_input: str) -> Any:
        ...
        elif detail_type in ["characteristics", "aggravating_factors", "relieving_factors", 
    ...
    def extract_duration(self, symptom_name: str, user_input: str) -> Dict:
        ...
        try:
            ...
            if hasattr(content, 'strip'):
                ...
                # For testing with mocks
                return {"start_date": "2025-04-10T08:00:00", "end_date": None, "is_ongoing": True}
            return duration_data
        except json.JSONDecodeError:
            # Fallback if JSON parsing fails
            return {"start_date": None, "end_date": None, "is_ongoing": None}
    
    def extract_list_detail(self, symptom_name: str, detail_type: str, user_input: str) -> List[str]:
